          ...
          <div className="col-lg-12">
            <div className="wg-how-it-work grid-column-3 style-2">
              <div className="how-it-item hover-item">
                ...
                <div className="content">
                  <h4 className="title fw-9">
                    <Link to={`/how-to-work`}>Sign-up for a free account</Link>
                  </h4>
              ...
              <div className="how-it-item hover-item">
                ...
                <div className="content">
                  <h4 className="title fw-9">
                    <Link to={`/how-to-work`}> Lottery courier service</Link>
                  </h4>
                  <p className="text type-secondary fs-14">
              ...
              <div className="how-it-item hover-item">
                ...
                <div className="content">
                  <h4 className="title fw-9">
                    <Link to={`/how-to-work`}>Receive our notifications</Link>
                  </h4>
                  <p className="text type-secondary fs-14">
              ...
              <div className="how-it-item hover-item">
                ...
                <div className="content">
                  <h4 className="title fw-9">
                    <Link to={`/how-to-work`}>Receive the winner's reward</Link>
                  </h4>
                  <p className="text type-secondary fs-14">
