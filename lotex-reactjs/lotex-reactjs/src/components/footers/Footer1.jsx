            ...
            <div className="col-12">
              <div className="footer-menu">
                ...
                <ul className="menu overflow-x-auto">
                  ...
                  <li>
                    <Link to={`/contest-details/1`}>CONTEST</Link>
                  </li>
                  <li>
                    <Link to={`/winner-list`}>WINNERS</Link>
                  </li>
                  <li>
                    <a href="#">PAGES</a>
                  </li>
          ...
          <div className="row">
            <div className="col-lg-3 col-sm-6">
              <div className="widget-footer">
                ...
                <ul>
                  ...
                  <li>
                    <Link to={`/blog-list`}>Latest News</Link>
                  </li>
                  <li>
                    <a href="#">Careers</a>
                  </li>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="widget-footer">
                ...
                <ul>
                  ...
                  <li>
                    <Link to={`/faq`}>Unclaimed prizes </Link>
                  </li>
                  <li>
                    <Link to={`/faq`}>How to play - Games Info </Link>
                  </li>
                  <li>
                    <Link to={`/faq`}>Games End Notices </Link>
                  </li>
                  <li>
                    <Link to={`/faq`}>Syndicates</Link>
                  </li>
                  <li>
                    <Link to={`/faq`}>Supported Browsers</Link>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="widget-footer help">
                ...
                <Link className="tf-btn" to={`/contact`}>
